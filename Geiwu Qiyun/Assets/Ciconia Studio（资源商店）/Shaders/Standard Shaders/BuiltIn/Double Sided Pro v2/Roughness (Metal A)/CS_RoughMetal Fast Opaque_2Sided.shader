Shader "Ciconia Studio/Standard (Double Sided) V2 Legacy/Roughness Setup/Fast/Opaque"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 Emissivemap31 = ( ( _EmissionColor * tex2D( _EmissionMap, ( uv_EmissionMap * TilingLayer1105 ) ) * _EmissiveIntensity1 ) + ( lerp(temp_cast_8,( _CubemapColor * float4( desaturateVar101 , 0.0 ) ),_EnableReflection) + ( temp_output_5_0_g50 * _AmbientLight1 ) + ( ( ( 0.95 * fresnelNode11_g53 ) + 0.05 ) * _FresnelStrength1 ) ) );
