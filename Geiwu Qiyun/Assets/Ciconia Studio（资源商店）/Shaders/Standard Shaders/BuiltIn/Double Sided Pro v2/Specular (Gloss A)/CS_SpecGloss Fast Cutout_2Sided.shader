Shader "Ciconia Studio/Standard (Double Sided) V2 Legacy/Specular Gloss/Fast/Cutout"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float temp_output_8_0_g59 = Albedomap34.r;
			float4 temp_output_5_0_g59 = ( temp_output_8_0_g59 * UNITY_LIGHTMODEL_AMBIENT );
			float4 Emissivemap31 = ( ( _EmissionColor * tex2D( _EmissionMap, ( uv_EmissionMap * TilingLayer1105 ) ) * _EmissiveIntensity1 ) + ( lerp(temp_cast_8,( _CubemapColor * float4( desaturateVar101 , 0.0 ) ),_EnableReflection) + ( temp_output_5_0_g59 * _AmbientLight1 ) ) );
			o.Emission = Emissivemap31.rgb;
			float3 ase_worldPos = i.worldPos;
			float3 ase_worldViewDir = normalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			float3 ase_worldNormal = i.worldNormal;
			float fresnelNdotV11_g61 = dot( ase_worldNormal, ase_worldViewDir );
			float fresnelNode11_g61 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV11_g61, 5.0 ) );
			float Specularmap95 = ( _SpecularIntensity + ( ( ( 0.95 * fresnelNode11_g61 ) + 0.05 ) * _FresnelStrength1 ) );
			...
			float temp_output_1_0_g63 = AAlbedo1117;
			float2 uv_Additionalmap = i.uv_texcoord * _Additionalmap_ST.xy + _Additionalmap_ST.zw;
			float4 tex2DNode28_g63 = tex2D( _Additionalmap, uv_Additionalmap );
			float blendOpSrc26_g63 = lerp(lerp(temp_output_1_0_g63,( 1.0 - temp_output_1_0_g63 ),_InvertAlbedoAlpha),1.0,_DisableAlbedoAlphaChannel);
			float blendOpDest26_g63 = lerp(( 1.0 - tex2DNode28_g63.r ),tex2DNode28_g63.r,_InvertAdditionalmap);
			float clampResult36_g63 = clamp( ( saturate( ( blendOpSrc26_g63 * blendOpDest26_g63 ) )) , 0.0 , 1.0 );
			float Opacity115 = clampResult36_g63;
